...
architecture behav of MatchCalculator_L4PHIB is 
    ...
    "MatchCalculator_L4PHIB,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcvu7p-flvb2104-1-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.505500,HLS_SYN_LAT=114,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=1662,HLS_SYN_LUT=6142,HLS_VERSION=2019_2}";
    ...
    signal LUT_matchcut_phi1_load_reg_8022 : STD_LOGIC_VECTOR (8 downto 0);
