...
entity MatchEngineTop_L5_table1_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 9; 
...
architecture rtl of MatchEngineTop_L5_table1_rom is 
...
entity MatchEngineTop_L5_table1 is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of MatchEngineTop_L5_table1 is
    component MatchEngineTop_L5_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    MatchEngineTop_L5_table1_rom_U :  component MatchEngineTop_L5_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
