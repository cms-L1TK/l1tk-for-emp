...
entity InputRouterTop_IR_DTC_2S_2_B is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of InputRouterTop_IR_DTC_2S_2_B is 
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L1 IS
    generic (
        DataWidth : INTEGER;
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L2 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L3 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L4 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L5 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L6 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    kPhiCorrtable_L1_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L1
    generic map (
        DataWidth => 15,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    kPhiCorrtable_L2_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L2
    generic map (
        DataWidth => 14,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    kPhiCorrtable_L3_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L3
    generic map (
        DataWidth => 14,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    kPhiCorrtable_L4_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L4
    generic map (
        DataWidth => 16,
        AddressRange => 128,
        AddressWidth => 7)
    ...
    kPhiCorrtable_L5_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L5
    generic map (
        DataWidth => 16,
        AddressRange => 128,
        AddressWidth => 7)
    ...
    kPhiCorrtable_L6_U : component InputRouterTop_IR_DTC_2S_2_B_kPhiCorrtable_L6
    generic map (
        DataWidth => 16,
        AddressRange => 128,
        AddressWidth => 7)
