...
entity InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1_rom is 
    generic(
             DWIDTH     : integer := 15; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1_rom is 
...
entity InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1 is
    generic (
...
architecture arch of InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1 is
    component InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1_rom_U :  component InputRouterTop_IR_DTC_2S_3_B_kPhiCorrtable_L1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
