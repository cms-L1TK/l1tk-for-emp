...
entity InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 7; 
...
architecture rtl of InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6_rom is 
...
entity InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6 is
    generic (
...
architecture arch of InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6 is
    component InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6_rom_U :  component InputRouterTop_IR_DTC_PS_2_B_kPhiCorrtable_L6_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
