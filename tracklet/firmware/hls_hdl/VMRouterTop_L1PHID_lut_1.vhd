...
entity VMRouterTop_L1PHID_lut_1_rom is 
    generic(
             DWIDTH     : integer := 15; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of VMRouterTop_L1PHID_lut_1_rom is 
...
entity VMRouterTop_L1PHID_lut_1 is
    generic (
...
architecture arch of VMRouterTop_L1PHID_lut_1 is
    component VMRouterTop_L1PHID_lut_1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    VMRouterTop_L1PHID_lut_1_rom_U :  component VMRouterTop_L1PHID_lut_1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
