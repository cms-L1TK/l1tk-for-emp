...
entity InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3_rom is 
    generic(
             DWIDTH     : integer := 14; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3_rom is 
...
entity InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3 is
    generic (
...
architecture arch of InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3 is
    component InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3_rom_U :  component InputRouterTop_IR_DTC_PS10G_2_B_kPhiCorrtable_L3_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
