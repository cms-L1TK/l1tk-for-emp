...
entity VMRouterTop_L2PHIB_mux_647_7_1_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of VMRouterTop_L2PHIB_mux_647_7_1_1 is
    ...
    signal mux_1_5    : std_logic_vector(6 downto 0);
    signal mux_1_6    : std_logic_vector(6 downto 0);
    signal mux_1_7    : std_logic_vector(6 downto 0);
    signal mux_1_8    : std_logic_vector(6 downto 0);
    signal mux_1_9    : std_logic_vector(6 downto 0);
    signal mux_1_10    : std_logic_vector(6 downto 0);
    signal mux_1_11    : std_logic_vector(6 downto 0);
    signal mux_1_12    : std_logic_vector(6 downto 0);
    signal mux_1_13    : std_logic_vector(6 downto 0);
    signal mux_1_14    : std_logic_vector(6 downto 0);
    signal mux_1_15    : std_logic_vector(6 downto 0);
    signal mux_1_16    : std_logic_vector(6 downto 0);
    signal mux_1_17    : std_logic_vector(6 downto 0);
    signal mux_1_18    : std_logic_vector(6 downto 0);
    signal mux_1_19    : std_logic_vector(6 downto 0);
    signal mux_1_20    : std_logic_vector(6 downto 0);
    signal mux_1_21    : std_logic_vector(6 downto 0);
    signal mux_1_22    : std_logic_vector(6 downto 0);
    signal mux_1_23    : std_logic_vector(6 downto 0);
    signal mux_1_24    : std_logic_vector(6 downto 0);
    signal mux_1_25    : std_logic_vector(6 downto 0);
    signal mux_1_26    : std_logic_vector(6 downto 0);
    signal mux_1_27    : std_logic_vector(6 downto 0);
    signal mux_1_28    : std_logic_vector(6 downto 0);
    signal mux_1_29    : std_logic_vector(6 downto 0);
    signal mux_1_30    : std_logic_vector(6 downto 0);
    signal mux_1_31    : std_logic_vector(6 downto 0);
    -- level 2 signals
    ...
    signal mux_2_3    : std_logic_vector(6 downto 0);
    signal mux_2_4    : std_logic_vector(6 downto 0);
    signal mux_2_5    : std_logic_vector(6 downto 0);
    signal mux_2_6    : std_logic_vector(6 downto 0);
    signal mux_2_7    : std_logic_vector(6 downto 0);
    signal mux_2_8    : std_logic_vector(6 downto 0);
    signal mux_2_9    : std_logic_vector(6 downto 0);
    signal mux_2_10    : std_logic_vector(6 downto 0);
    signal mux_2_11    : std_logic_vector(6 downto 0);
    signal mux_2_12    : std_logic_vector(6 downto 0);
    signal mux_2_13    : std_logic_vector(6 downto 0);
    signal mux_2_14    : std_logic_vector(6 downto 0);
    signal mux_2_15    : std_logic_vector(6 downto 0);
    -- level 3 signals
    signal mux_3_0    : std_logic_vector(6 downto 0);
    signal mux_3_1    : std_logic_vector(6 downto 0);
    signal mux_3_2    : std_logic_vector(6 downto 0);
    signal mux_3_3    : std_logic_vector(6 downto 0);
    signal mux_3_4    : std_logic_vector(6 downto 0);
    signal mux_3_5    : std_logic_vector(6 downto 0);
    signal mux_3_6    : std_logic_vector(6 downto 0);
    signal mux_3_7    : std_logic_vector(6 downto 0);
    -- level 4 signals
    signal mux_4_0    : std_logic_vector(6 downto 0);
    signal mux_4_1    : std_logic_vector(6 downto 0);
    signal mux_4_2    : std_logic_vector(6 downto 0);
    signal mux_4_3    : std_logic_vector(6 downto 0);
    -- level 5 signals
    signal mux_5_0    : std_logic_vector(6 downto 0);
    signal mux_5_1    : std_logic_vector(6 downto 0);
    -- level 6 signals
    signal mux_6_0    : std_logic_vector(6 downto 0);
    -- level 7 signals
    signal mux_7_0    : std_logic_vector(6 downto 0);
begin
