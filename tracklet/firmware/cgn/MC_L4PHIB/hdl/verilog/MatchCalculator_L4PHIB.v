...
wire   [8:0] LUT_matchcut_phi1_q0;
wire   [3:0] LUT_matchcut_z2_address0;
reg    LUT_matchcut_z2_ce0;
wire   [6:0] LUT_matchcut_z2_q0;
...
reg   [8:0] LUT_matchcut_phi1_load_reg_8008;
...
wire   [7:0] zext_ln215_fu_6893_p1;
wire   [7:0] ret_V_3_fu_6897_p2;
...
MatchCalculator_L4PHIB_LUT_matchcut_phi1 #(
    .DataWidth( 9 ),
    .AddressRange( 12 ),
    .AddressWidth( 4 ))
LUT_matchcut_phi1_U(
...
MatchCalculator_L4PHIB_LUT_matchcut_z2 #(
    .DataWidth( 7 ),
    .AddressRange( 12 ),
    .AddressWidth( 4 ))
LUT_matchcut_z2_U(
...
MatchCalculator_L4PHIB_mac_muladd_7s_9s_11ns_16_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 7 ),
    .din1_WIDTH( 9 ),
    .din2_WIDTH( 11 ),
    .dout_WIDTH( 16 ))
MatchCalculator_L4PHIB_mac_muladd_7s_9s_11ns_16_1_1_U1(
...
assign ret_V_3_fu_6897_p2 = (8'd0 - zext_ln215_fu_6893_p1);
...
endmodule //MatchCalculator_L4PHIB
